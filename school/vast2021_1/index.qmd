...
pacman::p_load(ggplot2, tidyverse, readr, grid, plotly, writexl, qwraps2, reshape2, scales, sf, raster, tmap, 
               clock, forcats, readxl, lubridate, fuzzyjoin, ggridges, GGally, kableExtra, terra)
...
# mc2 <- brick("data/MC2-tourist_modified.tif")     # Add tif file as a raster layer
# mc2 <- rast("data/MC2-tourist_modified.tif")      # Add tif file as a raster layer
