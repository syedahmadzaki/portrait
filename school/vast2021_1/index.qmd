...
pacman::p_load(ggplot2, tidyverse, readr, grid, plotly, writexl, qwraps2, 
               reshape2, scales, sf, raster, tmap, clock, forcats, readxl,
               lubridate, fuzzyjoin, ggridges, GGally, kableExtra)

```

**Team Member:**\
Syed Ahmad Zaki, Singapore Management University\
Student Team: YES
...
<!-- ```{r fuzzyjoin-innerjoin-stringdist-cc-loyalty} -->
...
<!-- ```{r tmap-visualisation, echo = T, message = FALSE} -->
...
<!-- ```{r cc-no-vehicles-on-weekends-before-midday} -->
...
<!-- ```{r cc-loyalty-match, fig.height=9} -->
...
<!-- ```{r gps-no-vehicles-on-weekends-before-midday} -->
...
<!-- ```{r fuzzyjoin-innerjoin-stringdist-cc-spots} -->
