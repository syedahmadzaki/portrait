...
description: "Investigating the Mini-Challenge 2 of VAST Challenge 2021: A Continuation"
author: 
...
### 5.4 Question 4 And Its Answers (A Continuation From [Part 1](https://syedahmadzaki.netlify.app/school/vast2021_1/))
...
```{r elsa-brand-couple, warning = FALSE, message = FALSE}
#| code-fold: show
...
```{r hennie-osvaldo-two-homes, warning = FALSE, message = FALSE}
#| code-fold: show
...
```{r bertrand-linnea-couple, warning = FALSE, message = FALSE}
#| code-fold: show
...
```{r lidelse-birgitta-couple, warning = FALSE, message = FALSE}
#| code-fold: show
...
### Continuing On To [Part 3](https://syedahmadzaki.netlify.app/school/vast2021_3/)
